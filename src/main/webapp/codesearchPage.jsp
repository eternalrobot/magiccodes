                    ...
                    <div class="col-md-6 col-md-push-3">
                        <fieldset>
                            <div class="text-center">
                                <h1 data-toggle="tooltip" title="Search code according to description, input and output">代码搜索</h1>
                            </div>
                        </fieldset>
                        <fieldset>
                            <div class="form-group">
                                <div>
                                    <input type="text" placeholder="Search for the input you want (int,String,double......)" id="Input" class="form-control">
                                </div>
                            </div>
                        </fieldset>
                        <fieldset>
                            <div class="form-group">
                                <div>
                                    <input type="text" placeholder="Search for the output you want (int,String,double......)" id="Output" class="form-control">
                                </div>
                            </div>
                        </fieldset>
                        <fieldset>
                            <div class="form-group">
                                <div>
                                    <input type="text" placeholder="Detailed description" id="Detial" class="form-control">
                                </div>
                            </div>
                        </fieldset>
                        <fieldset>
                            <div class="form-group">
                                <div class="col-sm-push-10 col-sm-2">
                                    <button class="btn btn-fill" id="CodeSearch" onclick="clickCodeSearch()" style="display: none">搜索</button>
                                </div>
                            </div>
                        </fieldset>
                    </div>
...
<script src="resource/javascript/codesearchPage.js"></script>
