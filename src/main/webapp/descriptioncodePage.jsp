                    ...
                    <div class="col-md-6 col-md-push-3">
                        <fieldset>
                            <div class="text-center">
                                <h1 data-toggle="tooltip" title="Search code according to description">通过描述搜索</h1>
                            </div>
                        </fieldset>
                        <fieldset>
                        ...
                        <fieldset>
                            <div class="form-group">
                                <div class="col-sm-push-10 col-sm-2">
                                    <button class="btn btn-fill" id="DescriptionSearch" onclick="clickDescriptionSearch()" style="display: none">Search</button>
                                </div>
                            </div>
                        </fieldset>
                    </div>
...
<%--<nav class="navbar navbar-default" role="navigation" style="background-color: white">--%>
    <%--<div class="container-fluid">--%>
        <%--<div class="navbar-header">--%>
            <%--<a class="navbar-brand" href="/descriptioncode">Description Code</a>--%>
        <%--</div>--%>
        <%--<div>--%>
            <%--<ul class="nav navbar-nav navbar-right">--%>
                <%--<li class="dropdown">--%>
...
<script src="resource/javascript/descriptioncodePage.js"></script>
